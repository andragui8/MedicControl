...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GTMSessionFetcher-iOS12.0/GTMSessionFetcher.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleUtilities-iOS12.0/GoogleUtilities.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/leveldb-library-iOS12.0/leveldb.framework"
